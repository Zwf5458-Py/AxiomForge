...
3. **申报更多极速小额资助平台**：
   ...
   - **OpenAI Researcher Access Program**：可直接申领 $2,500~$5,000 美元的免费 API Token，申报全套文案已完成（见 [`docs/grants/openai_researcher_access_application.md`](file:///Users/oraclez/code/数学模型/docs/grants/openai_researcher_access_application.md)）。
