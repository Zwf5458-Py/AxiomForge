...
> **评测协议**：3 组独立随机种子重复试验，相同候选采样预算（每组 5 轮）  
> **实验时间**：2026-09-13 07:58:01  
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **对照组 (Naive)** | 3 | **32 ± 0.0** | 32 | [32, 32] | 基准线 | 达成率 71.1% |
| **实验组 (Symmetry)** | 3 | **36.33 ± 2.08** | 37 | [34, 38] | **+4.33 点 (+13.5%)** | 达成率 84.4% |
