...
(function () {
  ...
  const DICTIONARY = {
    en: {
      ...
      btn_eulerbrick_search: 'Search Min Residual',
      btn_eulerbrick_ai_reason: 'AI Model Reasoning',
      eulerbrick_ai_cot_summary: '⚡ AI Diophantine Reasoning Chain (CoT)',
      btn_eulerbrick_apply_ai: 'Apply & Render 3D',
      eulerbrick_ai_thinking: 'Thinking & deducing Diophantine equations...',
    ...
    zh: {
      ...
      btn_eulerbrick_ai_reason: 'AI 模型推理',
      eulerbrick_ai_cot_summary: '⚡ AI 深度数论推演思考链 (CoT)',
      btn_eulerbrick_apply_ai: '一键应用至 3D 长方体',
      eulerbrick_ai_thinking: '正在推演数论方程与同余筛选...',
